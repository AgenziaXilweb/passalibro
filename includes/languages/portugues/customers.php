...
define('HEADING_TITLE_SEARCH', 'Procura:');

define('TABLE_HEADING_FIRSTNAME', 'Nome');
define('TABLE_HEADING_LASTNAME', 'Apelido');
...
define('TEXT_DATE_ACCOUNT_LAST_MODIFIED', '&Uacute;ltima altera&ccedil;&atilde;o:');
define('TEXT_INFO_DATE_LAST_LOGON', '&Uacute;ltima entrada:');
define('TEXT_INFO_NUMBER_OF_LOGONS', 'N&uacute;mero de Entradas:');
define('TEXT_INFO_COUNTRY', 'Pa&iacute;s:');
define('TEXT_INFO_NUMBER_OF_REVIEWS', 'N&uacute;mero de coment&aacute;rios:');
define('TEXT_DELETE_INTRO', 'Tem a certeza que quer apagar este cliente?');
define('TEXT_DELETE_REVIEWS', 'Apagar os coment&aacute;rios de %s ');
define('TEXT_INFO_HEADING_DELETE_CUSTOMER', 'Apagar cliente');
define('TYPE_BELOW', 'Escreva abaixo');
define('PLEASE_SELECT', 'Escolha um');
