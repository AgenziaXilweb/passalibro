...
?>
      <tr>
        <td><div style="padding:5px 20px"><?php echo $messageStack->output('account'); ?></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2">
          <tr class="infoBoxContents">
            <td class="main" align="center" valign="top" width="130"><?php echo '<b>' . OVERVIEW_PREVIOUS_ORDERS . '</b>'; ?></td></tr><tr>
