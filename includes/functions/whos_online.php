...
*/
  ...
  function tep_update_whos_online() {
    ...
    #Modifca per aggiornamento alla v 2.3.3.1 con HIGH SEVERETY
    ...
    #####################
    $current_time = time();
    $xx_mins_ago = ($current_time - 3600); //Nel caso di modifica, modificare anche il valore di $SESS_LIFE nel file session.php
