...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $color = null) {
    ...
    $classe = 'class="adozioni"';
        
    }elseif($color == 'usato'){
        
    $classe = 'class="adozioni_used"';  
        
    }elseif($color == 'prenotato'){
     
    $classe = 'class="adozioni_reserved"';    
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
      ...
      $button .= '<a ' . $classe . ' id="tdb' . $button_counter . '" href="' . $link . '"';

      if ( isset($params['newwindow']) ) {
        $button .= ' target="_blank"';
      }
    } else {
      $button .= '<button class="adozioni" id="tdb' . $button_counter . '" type="' . tep_output_string($params['type']) . '"';
    }
 ...
 // Marco 26/03/2013 - Modifica bottone standard.  
  
  function tep_draw_other_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $color = null) {
    static $button_counter = 1;

    $types = array('submit', 'button', 'reset');
    
        $classe = 'class="other_button"';
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
      ...
      $button .= '<button '.$classe.' id="tdb' . $button_counter . '" type="' . tep_output_string($params['type']) . '"';
    }
 ...
 // Marco 26/03/2013 - Fine Modifica bottone standard. 
?>
