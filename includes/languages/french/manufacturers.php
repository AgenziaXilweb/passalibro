...
define('ERROR_DIRECTORY_NOT_WRITEABLE', 'Erreur : Impossible d&acute;&eacute;crire dans le r&eacute;pertoire. Merci de modifier les droits d&acute;acc&egrave;s sur : %s');
define('ERROR_DIRECTORY_DOES_NOT_EXIST', 'Erreur : Le r&eacute;pertoire n&acute;existe pas : %s');
?>