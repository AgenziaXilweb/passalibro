<table border="0" width="100%" cellspacing="0" cellpadding="0" class="head_table">
        ...
        </table><?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL')); ?><table border="0" cellspacing="0" cellpadding="0"width="100%">
      ...
      <tr>
        <td><table border="0" width="100%" height="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr>
            ...
            </table><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
              <tr>
