...
define('TEXT_MORE_INFORMATION', 'Per ulteriori informazioni, visita il <a href="%s" target="_blank"><u>sito</u></a>.');
define('TEXT_DATE_ADDED', 'Questo prodotto è stato aggiunto al nostro catalogo il %s.');
define('TEXT_DATE_AVAILABLE', '<font color="#ff0000">Questo Prodotto è in magazzino dal %s.</font>');
define('TEXT_ALSO_PURCHASED_PRODUCTS', '<h1>Questi sono i prodotti visti dai clienti ed anche comprati!</h1>');
