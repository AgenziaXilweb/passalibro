...
define('TABLE_HEADING_OPT_SORT_ORDER', 'Reihenfolge');
define('TABLE_TEXT_FROM', 'Von: ');
define('TABLE_TEXT_TO', 'Bis: ');
define('HEADING_TITLE_CLONE', 'Produkt-Attribute klonen');
define('TABLE_HEADING_OPT_OPTIONS_VALUES_WEIGHT', 'Values Weight');
