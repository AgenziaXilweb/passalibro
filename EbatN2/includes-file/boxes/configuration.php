...
*/
  ...
  $cl_box_groups[] = array(
    ...
    'apps' => array(
      ...
      array(
        'code' => FILENAME_WAREHOUSES,
        'title' => BOX_CONFIGURATION_WAREHOUSES,
        'link' => tep_href_link(FILENAME_WAREHOUSES)
      )
    )
  );

  $configuration_groups_query = tep_db_query("select configuration_group_id as cgID, configuration_group_title as cgTitle from " . TABLE_CONFIGURATION_GROUP . " where visible = '2' order by sort_order");
