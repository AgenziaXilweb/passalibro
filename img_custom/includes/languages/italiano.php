...
define('BOX_SEARCH_ADVANCED_SEARCH', 'erweiterte');
define('BOX_HEADING_SEARCH1', '');
...
define('BOX_IN_YOUR_CART','in Warenkorb');
...
define('BOX_HEADING_LANGUAGES', 'Spr&auml;che:');
...
define('JS_ERROR_NO_PAYMENT_MODULE_SELECTED', '* Bitte whlen Sie eine Zahlungsweise fr Ihre Bestellung.\n');

define('JS_ERROR_SUBMITTED', 'Diese Seite wurde bereits besttigt. Bettigen Sie bitte OK und warten bis der Prozess durchgefhrt wurde.');

define('ERROR_NO_PAYMENT_MODULE_SELECTED', 'Bitte whlen Sie eine Zahlungsweise fr Ihre Bestellung.');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Die eMail Adresse scheint nicht gltig zu sein - bitte korrigieren.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Die eMail Adresse ist bereits gespeichert - bitte melden Sie sich mit dieser Adresse an oder erffnen Sie ein neues Konto mit einer anderen Adresse.');
...
define('ENTRY_STATE_ERROR_SELECT', 'Bitte whlen Sie ein Bundesland aus der Liste.');
define('ENTRY_STATE_TEXT', '*');
define('ENTRY_COUNTRY', 'Land:');
define('ENTRY_COUNTRY_ERROR', 'Bitte whlen Sie ein Land aus der Liste.');
...
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING', 'Beide eingegebenen Passwrter mssen identisch sein.');
...
define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', 'Die Passwort-Besttigung muss mit Ihrem neuen Passwort bereinstimmen.');
...
define('IMAGE_BUTTON_REMOVE_NOTIFICATIONS', 'Benachrichtigungen lschen');
...
define('ERROR_TEP_MAIL', '<font face="Verdana, Arial" size="2" color="#760C0F"><b><small>Fehler:</small> Die eMail kann nicht &uuml;ber den angegebenen SMTP-Server verschickt werden. Bitte kontrollieren Sie die Einstellungen in der php.ini Datei und f&uuml;hren Sie notwendige Korrekturen durch!</b></font>');
...
define('WARNING_DOWNLOAD_DIRECTORY_NON_EXISTENT', 'Warnung: Das Verzeichnis fr den Artikel Download existiert nicht: ' . DIR_FS_DOWNLOAD . '. Diese Funktion wird nicht funktionieren bis das Verzeichnis erstellt wurde!');
...
define('FOOTER_TEXT_BODY', '&copy; <span style="color:#BB0203">'. STORE_NAME .'</span> online shop. ' . date('Y') . '. ');
define('ARTICLE_1','Artikel 1');
define('ARTICLE_2','Artikel 2');
define('ARTICLE_3','Artikel 3');
define('ARTICLE_4','Artikel 4');
define('ARTICLE_5','Artikel 5');
define('BOX_WHOS_ONLINE','Wer ist online');
define('BOX_WHOS_ONLINE_TEXT1','There currently are');
define('BOX_WHOS_ONLINE_TEXT2','guests online');
?>
