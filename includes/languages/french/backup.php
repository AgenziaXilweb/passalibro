...
define('TEXT_INFO_BEST_THROUGH_HTTPS', 'Le meilleur serait le cas d&acute;une connexion HTTPS');
...
define('ERROR_BACKUP_DIRECTORY_DOES_NOT_EXIST', 'Erreur : Le r&eacute;pertoire de sauvegarde n&acute;existe pas. Merci de le pr&eacute;ciser dans le fichier configure.php.');
define('ERROR_BACKUP_DIRECTORY_NOT_WRITEABLE', 'Erreur : Impossible d&acute;&eacute;crire dans le r&eacute;pertoire de sauvegarde.');
