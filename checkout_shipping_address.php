...
?>
  ...
  <div class="contentText">
    ...
    <div style="float: right;"><?php echo tep_draw_hidden_field('action', 'submit') . tep_draw_other_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></div>
  </div>
...
?>
  ...
  <div class="contentText">
    <?php echo tep_draw_other_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL')); ?>
  </div>
