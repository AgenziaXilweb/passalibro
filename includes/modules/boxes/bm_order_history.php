...
// retreive the last x products purchased
        ...
        if (tep_db_num_rows($orders_query)) {
          ...
          $customer_orders_string = '<div class="ui-widget-content infoBoxContents">';
          ...
          while ($products = tep_db_fetch_array($products_query)) {
            $customer_orders_string .= '<span class="btn-pTool"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products['products_id']) . '">' . substr($products['products_name'],0,17) . '...' . '</a></span><br>';
          }
          $customer_orders_string .= '<br></div>';
