  ...
  class bm_information {
    ...
    function execute() {
      ...
      $data = '<div class="ui-widget infoBoxContainer">' .
              ...
              '    <span class="btn-pTool"><a href="' . tep_href_link(FILENAME_SHIPPING) . '">' . MODULE_BOXES_INFORMATION_BOX_SHIPPING . '</a></span><br />' .
              '    <span class="btn-pTool"><a href="' . tep_href_link(FILENAME_PRIVACY) . '">' . MODULE_BOXES_INFORMATION_BOX_PRIVACY . '</a></span><br />' .
              '    <span class="btn-pTool"><a href="' . tep_href_link(FILENAME_CONDITIONS) . '">' . MODULE_BOXES_INFORMATION_BOX_CONDITIONS . '</a></span><br />' .
              '    <span class="btn-pTool"><a href="' . tep_href_link(FILENAME_CONTACT_US) . '">' . MODULE_BOXES_INFORMATION_BOX_CONTACT . '</a></span><br /><br />' .
              '  </div>' .
              '</div>';
