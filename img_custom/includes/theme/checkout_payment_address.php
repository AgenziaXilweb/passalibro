<table border="0" width="<?php echo $content; ?>" cellspacing="0" cellpadding="0" class="head_table">
          <tr>
            ...
            <td class="pageHeading2" align="right"><?php echo tep_image(DIR_WS_IMAGES . 'table_background_payment.gif', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
          </tr>
        </table><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
<?php
  echo START_BLOCK;
?>
<?php
...
?>
      <tr>
        <td><td class="main"><b><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></b></td></td>
      </tr>
      <tr>
        ...
        <td><center><table border="0" width="80%" cellspacing="0" cellpadding="0">
          <tr style="background:url(images/pixel_silver.gif) left repeat-x;">
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" align="right"><?php echo tep_draw_separator('pixel_trans.gif', '1', '5'); ?></td>
