<table border="0" width="<?php echo $content; ?>" cellspacing="0" cellpadding="0" class="head_table">
          <tr>
            ...
            <td class="pageHeading2" align="right" style="padding:0"><?php echo tep_image(DIR_WS_IMAGES . 'table_background_browse.gif', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
          </tr>
...
// create column list
  ...
  require(DIR_WS_MODULES . "product_listing_2.php");
?>
        </td>
      </tr>
      <tr>
