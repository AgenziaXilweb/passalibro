...
define('TEXT_PRODUCT_MORE_INFORMATION', 'Pour plus d&acute;information, merci de visiter cette <a href="http://%s" target="blank"><u>page web</u></a> de produits.');
...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Erreur : Impossible d&acute;&eacute;crire dans le r&eacute;pertoire images : ' . DIR_FS_CATALOG_IMAGES);
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Erreur : Le r&eacute;pertoire d&acute;images n&acute;existe pas : ' . DIR_FS_CATALOG_IMAGES);
