...
?>
          <td width="<?php echo (($sendto != false) ? '70%' : '100%'); ?>" valign="top"><table border="0" width="100%" cellspacing="4" cellpadding="2">
              <tr>
...
?>
  ...
  echo tep_image_submit('button_confirm_order.gif', IMAGE_BUTTON_CONFIRM_ORDER, 'class="checkout_input"') . "\n";
?>
          </td>
        </tr>
      </table></td>
