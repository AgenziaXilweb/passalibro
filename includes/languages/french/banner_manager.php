...
define('TEXT_BANNERS_INSERT_NOTE', '<b>Remarque sur l&acute;image :</b><ul><li>Le r&eacute;pertoire de destination lors du transfert doit avoir les bonnes permissions (&eacute;criture) sur le serveur!</li><li>Ne remplissez pas la cible de l&acute;image (\'Sauvegarder dans\') si vous ne transf&eacute;rez pas d&acute;image sur le serveur web (dans le cas o&ugrave; vous utilisez une image d&eacute;ja pr&eacute;sente sur celui-ci).</li><li>La cible de l&acute;image (\'Sauvegarder dans\') doit pointer sur un r&eacute;pertoire existant et le slash de fin doit &ecirc;tre pr&eacute;sent (ex., banners/).</li></ul>');
define('TEXT_BANNERS_EXPIRCY_NOTE', '<b>Remarque sur l&acute;expiration :</b><ul><li>Seul un des 2 champs doit &ecirc;tre saisi.</li><li>Pour laisser la banni&egrave;re active, sans expiration automatique, laisser ces champs vides.</li></ul>');
define('TEXT_BANNERS_SCHEDULE_NOTE', '<b>Remarque sur la planification :</b><ul><li>Si la date de planification est pr&eacute;cis&eacute;e, la banni&egrave;re sera activ&eacute;e seulement &agrave; partir de cette date.</li><li>Toutes les banni&egrave;res planifi&eacute;es seront marqu&eacute;es inactives jusqu&acute;&agrave; ce que la date de planification soit atteinte. Elles seront alors actives.</li></ul>');

define('TEXT_BANNERS_DATE_ADDED', 'Date d&acute;ajout :');
...
define('TEXT_BANNERS_BANNER_VIEWS', 'Nombre d&acute;affichages');
...
define('TEXT_INFO_DELETE_IMAGE', 'Supprimer l&acute;image de la banni&egrave;re');
...
define('ERROR_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Erreur : Le r&eacute;pertoire cible n&acute;existe pas: %s');
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Erreur : Target directory is not writeable: %s');
define('ERROR_IMAGE_DOES_NOT_EXIST', 'Erreur : L&acute;image n&acute;existe pas.');
define('ERROR_IMAGE_IS_NOT_WRITEABLE', 'Erreur : L&acute;image ne peut pas &ecirc;tre supprim&eacute;e.');
define('ERROR_UNKNOWN_STATUS_FLAG', 'Erreur : Statut flag inconnu.');

define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', 'Erreur : Le r&eacute;pertoire de banni&egrave;res n&acute;existe pas. Cr&eacute;er un r&eacute;pertoire \'graphs\' dans \'images\'.');
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', 'Erreur : Le r&eacute;pertoire de banni&egrave;res n&acute;est pas autoris&eacute; en &eacute;criture.');
?>