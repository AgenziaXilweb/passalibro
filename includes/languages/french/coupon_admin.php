...
define('TEXT_TO_REDEEM', 'Vous pouvez utiliser le coupon pendant la proc&eacute;dure de payement. Entrez simplement le code dans la case appropri&eacute;e, et cliquez sur le bouton utiliser.');
...
define('REDEEM_DATE', 'Date d&acute;utilisation');
define('IP_ADDRESS', 'Adresse IP');

define('TEXT_REDEMPTIONS', 'Rapport d&acute;utilisation');
define('TEXT_REDEMPTIONS_TOTAL', 'Total d&acute;utilisation');
...
define('ERROR_NO_CUSTOMER_SELECTED', 'Erreur : aucun client n&acute;a &eacute;t&eacute; s&eacute;lectionn&eacute;.');
...
define('COUPON_STARTDATE', 'Date d&acute;effet');
define('COUPON_FINISHDATE', 'Date de fin d&acute;effet');
...
define('VOUCHER_NUMBER_USED', 'Nombre d&acute;utilisation');
...
define('COUPON_STARTDATE_HELP', 'D&eacute;but de la date d&acute;effet du coupon.');
define('COUPON_FINISHDATE_HELP', 'Fin de la date d&acute;effet du coupon.');
...
define('COUPON_MIN_ORDER_HELP', 'Montant minimum d&acute;une commande &agrave; partir duquel le coupon devient valide');
...
define('ERROR_NO_COUPON_AMOUNT', 'Erreur : Vous n&acute;avez pas remplis le minimum pour valider coupon');
