...
define('TEXT_DUPLICATE_IP', 'Dubbele IP adres(sen)');
define('TEXT_BOTS', 'Bot(s)-Crawler(s)');
define('TEXT_ME', 'Beheerder(s)');
define('TEXT_ALL', 'Allen');
define('TEXT_REAL_CUSTOMERS', 'Klant(en)');
define('TEXT_ACTIVE_CUSTOMERS', ' zijn actief.');
