...
<div class="contentContainer">
  ...
  <div class="contentText">
   ...
   <h2><?php echo MY_SCHOOL_TITLE; ?></h2>

  <div class="contentText">
    <ul class="accountLinkList">
      <li><span class="ui-icon ui-icon-cart accountLinkListEntry"></span><?php echo '<a href="' . tep_href_link(FILENAME_LIST_BOOKS, '', 'SSL') . '">' . MY_BOOKS_VIEW . '</a>'; ?></li>
    </ul>
  </div>
