...
define('JS_ALERT_EMAIL_FORMAT', '- Format der Email-Addresse ist unzul&auml;ssig! \n');
define('JS_ALERT_EMAIL_USED', '- Email-Addresse ist bereits vergeben! \n');
define('JS_ALERT_LEVEL', '- Erfordert: Gruppe \n');

define('ADMIN_EMAIL_SUBJECT', 'Neues Administrator Mitglied %s: %s %s');
define('ADMIN_EMAIL_TEXT', 'Hallo %s,' . "\n\n" . 'Sie k&ouml;nnen das Administrator-Pannel mit dem folgenden Kennwort &ouml;ffnen. Bitte das Passwort sofort &auml;ndern!' . "\n" . '%s' . "\n" . '%s' . "\n" . '%s' . "\n" . '%s');
define('ADMIN_EMAIL_EDIT_SUBJECT', 'Profil des Administrator wurde bearbeitet');
define('ADMIN_EMAIL_EDIT_TEXT', 'Hallo %s,' . "\n\n" . 'Ihre pers&ouml;nlichen Informationen sind von einem Administrator aktualisiert worden.' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Kennwort: %s' . "\n\n" . 'Danke!' . "\n" . '%s' . "\n\n" . 'Dieses ist eine automatissche Nachricht, bitte nicht antworten!');
...
define('TEXT_INFO_GROUPS_NAME_FALSE', '<font color="red"><b>Achtung:</b> Der Gruppenname mu&szlig; mehr als 5 Buchstaben haben!</font>');
...
define('TEXT_RIGHTS_CDELETE','Kategorie l&ouml;schen');
...
define('TEXT_RIGHTS_PDELETE','Produkt l&ouml;schen');
