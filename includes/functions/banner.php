...
////
// Auto active status banners - Marco 14/03/2013

  function tep_active_status($status, $contenitore) {
        
    $banners_query = tep_db_query("select status from " . TABLE_BANNERS . " where status ='".$status."'");
    $banners = tep_db_num_rows($banners_query);
