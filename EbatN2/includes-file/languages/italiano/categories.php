...
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Errore: Questa categoria non pu&ograve; essere mossa in usa sotto-categoria.');



//TotalB2B start

define('ENTRY_PRODUCTS_PRICE', 'Prezzo Prodotto #');

define('ENTRY_PRODUCTS_PRICE_DISABLED', 'disabilitato');
...
define('TEXT_PRODUCTS_DESCHOME', 'Descrizione in homepage');
