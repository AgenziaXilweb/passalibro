...
define('ERROR_REMOVE_DEFAULT_CURRENCY', 'Errore: La valuta di Default non pu&ograve; essere rimossa. Seleziona un\' altra Valuta  di default e riprova.');

define('ERROR_CURRENCY_INVALID', 'Errore: Il tasso di cambio di %s (%s) non &egrave; stato aggironato con successo a %s. E\' un codice di valuta valido?');
