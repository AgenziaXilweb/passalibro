...
define('HEADER_TITLE_LOGIN', 'Customer Login');
...
define('BOX_IN_YOUR_CART','in your cart');
...
define('ERROR_TEP_MAIL', '<font face="Verdana, Arial" size="2" color="#760C0F"><b><small>TEP ERROR:</small> Cannot send the email through the specified SMTP server. Please check your php.ini setting and correct the SMTP server if necessary.</b></font>');
...
define('ARTICLE_1','Article 1');
define('ARTICLE_2','Article 2');
define('ARTICLE_3','Article 3');
define('ARTICLE_4','Article 4');
define('ARTICLE_5','Article 5');
define('BOX_WHOS_ONLINE','Whos online:');
