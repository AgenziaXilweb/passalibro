...
define('TABLE_HEADING_DATE_PURCHASED', 'Date d&acute;achat');
...
define('TABLE_HEADING_DATE_ADDED', 'Date d&acute;ajout');
...
define('ENTRY_SHIPPING_ADDRESS', 'Adresse d&acute;exp&eacute;dition :');
...
define('ENTRY_CREDIT_CARD_EXPIRES', 'Date d&acute;expiration de la carte de cr&eacute;dit :');
define('ENTRY_SUB_TOTAL', 'Sous-Total :');
define('ENTRY_TAX', 'Taxe :');
define('ENTRY_SHIPPING', 'Exp&eacute;dition :');
define('ENTRY_TOTAL', 'Total :');
define('ENTRY_DATE_PURCHASED', 'Date d&acute;achat :');
...
define('ERROR_ORDER_DOES_NOT_EXIST', 'Erreur : La commande n&acute;existe pas.');
define('SUCCESS_ORDER_UPDATED', 'Succ&egrave;s : La commande est mise &agrave; jour avec succ&egrave;s.');
define('WARNING_ORDER_NOT_UPDATED', 'Attention : Aucune modification n&acute;a &eacute;t&eacute; effectu&eacute;e. La commande n&acute;a pas &eacute;t&eacute; mis &agrave; jour.');
?>