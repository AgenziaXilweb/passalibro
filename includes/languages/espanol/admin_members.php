...
define('TABLE_HEADING_ACTION', 'Acti&ograve;n');

define('TABLE_HEADING_GROUPS_NAME', 'Nombre Grupos');
define('TABLE_HEADING_GROUPS_DEFINE', 'Selecci&ograve;n de cajas y Ficheros');
...
define('TEXT_INFO_DELETE_INTRO', 'Borrar <div><b>%s</b></div> de <div>Miembros de Admin?</div>');
define('TEXT_INFO_DELETE_INTRO_NOT', 'No puedes eliminar el <div>grupo %s!</div>');
...
define('TEXT_INFO_ERROR', '<font color="#ff0000">Direccion de Email ya utilizada!</font>');
...
define('ADMIN_EMAIL_EDIT_SUBJECT', 'Cambios en la p&agrave;gina %s para el administrador %s %s');
...
define('TEXT_INFO_DELETE_GROUPS_INTRO', 'Esto elimina tambien los miembros del grupo. Quieres eliminar el <div>grupo <b>%s</b>?</div>');
...
define('TEXT_INFO_GROUPS_NAME', ' <b>Nombre Grupo:</b><br />Elije un nombre de grupo univoco. Despu&eacute;s, clica <b>sigue</b> para enviar.<br />');
...
define('TEXT_INFO_CATEGORIEACCESS', 'Accesso a categor&igrave;as:');
define('TEXT_RIGHTS_CNEW', 'Crear Categor&igrave;a');
define('TEXT_RIGHTS_CEDIT', 'Editar Categor&igrave;a');
define('TEXT_RIGHTS_CMOVE', 'Mover Categor&igrave;a');
define('TEXT_RIGHTS_CDELETE', 'Borrar categor&igrave;a');
