...
define('BOX_ADMINISTRATOR_MEMBERS', 'Groupes d&acute;utilisateurs');
...
define('BOX_TOOLS_NEWSLETTER_MANAGER', 'Gestionnaire de bulletin d&acute;information');
...
define('JS_REVIEW_TEXT', '* Le commentaire que vous avez saisi doit comporter au moins ' . REVIEW_TEXT_MIN_LENGTH . ' caract&egrave;res');
define('JS_REVIEW_RATING', '* Vous devez fournir une appr&eacute;ciation pour cet article.');
...
define('JS_GENDER', '* La valeur de &#39;Genre&#39; doit &ecirc;tre choisie.\n');
define('JS_FIRST_NAME', '* L&acute;entr&eacute;e &#39;Pr&eacute;nom&#39; doit avoir au moins ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_LAST_NAME', '* L&acute;entr&eacute;e &#39;Nom&#39; doit avoir au moins ' . ENTRY_LAST_NAME_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_DOB', '* L&acute;entr&eacute;e &#39;Date de naissance&#39; doit avoir la forme: xx/xx/xxxx (month/date/year).\n');
define('JS_EMAIL_ADDRESS', '* L&acute;entr&eacute;e &#39;Addresse &eacute;lectronique&#39; doit avoir au moins ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_ADDRESS', '* L&acute;entr&eacute;e &#39;Addresse&#39; doit avoir au moins ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_POST_CODE', '* L&acute;entr&eacute;e &#39;Code postal&#39; doit avoir au moins ' . ENTRY_POSTCODE_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_CITY', '* L&acute;entr&eacute;e &#39;Ville&#39; doit avoir au moins ' . ENTRY_CITY_MIN_LENGTH . ' caract&egrave;res.\n');
define('JS_STATE', '* L&acute;entr&eacute;e &#39;Etat&#39; doit avoir &eacute;t&eacute; choisie.\n');
define('JS_STATE_SELECT', '-- Choisissez ci-dessus --');
define('JS_ZONE', '* L&acute;entr&eacute;e &#39;Etat&#39; doit &ecirc;tre choisie parmi la liste pour ce pays.');
define('JS_COUNTRY', '* La valeur &#39;Pays&#39; doit &ecirc;tre choisie.\n');
define('JS_TELEPHONE', '* L&acute;entr&eacute;e &#39;Num&eacute;ro de t&eacute;l&eacute;phone&#39; doit avoir au moins ' . ENTRY_TELEPHONE_MIN_LENGTH . ' caract&egrave;res.\n');
...
define('JS_ORDER_DOES_NOT_EXIST', 'Le num&eacute;ro de commande %s n&acute;existe pas!');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '&nbsp;<span class="errorText">L&acute;adresse &eacute;lectronique ne semble pas &ecirc;tre valide!</span>');
...
define('ENTRY_NEWSLETTER', 'Bulletin d&acute;informations :');
...
define('IMAGE_NEW_NEWSLETTER', 'Nouveau bulletin d&acute;informations');
...
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> bulletin d&acute;informations)');
...
define('ERROR_NO_DEFAULT_CURRENCY_DEFINED', 'Erreur : Il n&acute;y a actuellement aucune devise par d&eacute;faut. Veuillez en choisir une: Outils administration->Localisation->Devises');

define('TEXT_CACHE_CATEGORIES', 'Bo&icirc;te cat&eacute;gories');
define('TEXT_CACHE_MANUFACTURERS', 'Bo&icirc;te fabricants');
define('TEXT_CACHE_ALSO_PURCHASED', 'Module d&acute;achat suppl&eacute;mentaire');

define('TEXT_NONE', '--aucun--');
define('TEXT_TOP', 'Haut');

define('ERROR_DESTINATION_DOES_NOT_EXIST', 'Erreur : le chemin cible n&acute;existe pas.');
define('ERROR_DESTINATION_NOT_WRITEABLE', 'Erreur : Impossible d&acute;&eacute;crire dans le r&eacute;pertoire cible.');
...
?>
<?php
  define('TEXT_MONTHS_01_NAME', 'janvier');
  define('TEXT_MONTHS_02_NAME', 'f&eacute;vrier');
  define('TEXT_MONTHS_03_NAME', 'mars');
  define('TEXT_MONTHS_04_NAME', 'avril');
  define('TEXT_MONTHS_05_NAME', 'mai');
  define('TEXT_MONTHS_06_NAME', 'juin');
  define('TEXT_MONTHS_07_NAME', 'juillet');
  define('TEXT_MONTHS_08_NAME', 'ao&ucirc;t');
  define('TEXT_MONTHS_09_NAME', 'septembre');
  define('TEXT_MONTHS_10_NAME', 'octobre');
  define('TEXT_MONTHS_11_NAME', 'novembre');
  define('TEXT_MONTHS_12_NAME', 'd&eacute;cembre');

  define('TEXT_WEEK_00_NAME', 'dimanche');
  define('TEXT_WEEK_01_NAME', 'lundi');
  define('TEXT_WEEK_02_NAME', 'mardi');
  define('TEXT_WEEK_03_NAME', 'mercredi');
  define('TEXT_WEEK_04_NAME', 'jeudi');
  define('TEXT_WEEK_05_NAME', 'vendredi');
  define('TEXT_WEEK_06_NAME', 'samedi');
?>