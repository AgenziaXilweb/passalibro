  ...
  class bm_categories {
    ...
    function tep_show_category($counter) {
      ...
      for ($i=0; $i<$tree[$counter]['level']; $i++) {
        ...
        $pulsante = $tree[$counter]['parent']==0?'<span class="btn-pTool"><a href="':'<span class="btn-lTool"><a href="';


      #$categories_string .= '<span class="btn-pTool"><a href="';
       $categories_string .= $pulsante;
...
// display category name
    ...
    function getData() {
      ...
      $data = '<div class="ui-widget infoBoxContainer">' .
              ...
              '  <div class="ui-widget-content infoBoxContents">' . $categories_string . '<br></div>' .
              '</div>';
