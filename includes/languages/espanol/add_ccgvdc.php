...
define('TEXT_VALID_CATEGORIES_LIST', 'Lista de Categor&igrave;as');
define('TEXT_VALID_CATEGORIES_ID', 'ID de Categor&igrave;as');
define('TEXT_VALID_CATEGORIES_NAME', 'Nombre de las Categor&igrave;as');
