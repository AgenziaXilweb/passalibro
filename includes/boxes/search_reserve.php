...
//									</table>
//								</td>
//								<td>'.tep_draw_separator('spacer.gif', '7', '1').'</td>
//								<td class="search_button-rep">
//									<table cellpadding="0" cellspacing="0" border="0" class="search_button-left">
//										<tr><td class="search_button-right">' . tep_image_submit('button2_search_prod.gif', '', '').'</td></tr>
//									</table>
//								</td>
//							</tr>
//                        </table>
//						<div class="advserch"><a href="' . tep_href_link(FILENAME_ADVANCED_SEARCH) . '">' . BOX_SEARCH_ADVANCED_SEARCH . '</a></div>');
//

echo "CIAOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
