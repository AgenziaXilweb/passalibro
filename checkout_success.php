...
/// Marco 21/05/2013 - aggiunti campi per ebay 

    $products_query = tep_db_query("select products_ebay, products_id, products_name, products_model, products_quantity, products_used_quantity from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . (int)$orders['orders_id'] . "' order by products_name");
    while ($products = tep_db_fetch_array($products_query)) {
      $products_array[] = array('id' => $products['products_id'],
                                'text' => $products['products_name'],
                                'ebay' => $products['products_ebay'],
                                'new_qty' => $products['products_quantity'],
                                'used_qty' => $products['products_used_quantity'],
                                'model' => $products['products_model']);


/// Marco 21/05/2013 - fine aggiunta campi
...
require(DIR_WS_INCLUDES . 'ebay_checkout_process.php');
