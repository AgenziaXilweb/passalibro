...
define('TABLE_HEADING_PRICE_INCLUDING_TAX', 'Prezzo (lordo)');

define('TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Totale (netto)');

define('TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Totale (lordo)');
...
define('EMAIL_TEXT_STATUS_UPDATE', 'Il tuo ordine &egrave; stato aggiornato al seguente stato.' . "\n\n" . 'Nuovo stato: %s' . "\n\n" . 'Rispondi a questa E-mail in caso di problemi.' ."\n");
...
define('WARNING_ORDER_NOT_UPDATED', 'Attenzione: Nessun cambiamento. L\'ordine non &egrave; stato aggiornato.');
...
// ### MODIFICA GESTIONE ORDINI ###
define('TABLE_HEADING_EDIT_ORDERS', 'Gestione Ordini');
define('TEXT_IMAGE_CREATE','Crea Ordine');
define('TEXT_INFO_CUSTOMER_SERVICE_ID','Inserito da:');
