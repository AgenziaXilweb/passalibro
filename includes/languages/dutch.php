...
define('JS_REVIEW_TEXT', '* De \'Review Tekst\' moet minimaal ' . REVIEW_TEXT_MIN_LENGTH . ' tekens bevatten.\n'); 
define('JS_REVIEW_RATING', '* Gelieve het product een waardering te geven voor de beoordeling.\n');
...
define('ENTRY_DATE_OF_BIRTH_ERROR', '&nbsp;<span class="errorText">(bijv. 31/01/1970)</span>');
...
define('IMAGE_EDIT_ATTRIBUTE', 'Wijzigen Attribute');
...
?>
<?php
  define('TEXT_MONTHS_01_NAME', 'januari');
  define('TEXT_MONTHS_02_NAME', 'februari');
  define('TEXT_MONTHS_03_NAME', 'maart');
  define('TEXT_MONTHS_04_NAME', 'april');
  define('TEXT_MONTHS_05_NAME', 'kunnen');
  define('TEXT_MONTHS_06_NAME', 'juni');
  define('TEXT_MONTHS_07_NAME', 'juli');
  define('TEXT_MONTHS_08_NAME', 'augustus');
  define('TEXT_MONTHS_09_NAME', 'september');
  define('TEXT_MONTHS_10_NAME', 'oktober');
  define('TEXT_MONTHS_11_NAME', 'november');
  define('TEXT_MONTHS_12_NAME', 'december');

  define('TEXT_WEEK_00_NAME', 'zondag');
  define('TEXT_WEEK_01_NAME', 'maandag');
  define('TEXT_WEEK_02_NAME', 'dinsdag');
  define('TEXT_WEEK_03_NAME', 'woensdag');
  define('TEXT_WEEK_04_NAME', 'donderdag');
  define('TEXT_WEEK_05_NAME', 'vrijdag');
  define('TEXT_WEEK_06_NAME', 'zaterdag');
?>