...
define('TABLE_HEADING_ENTRY_TIME', 'Entrada');
define('TABLE_HEADING_LAST_CLICK', '&Uacute;ltimo Clique');
define('TABLE_HEADING_LAST_PAGE_URL', '&Uacute;ltimo URL');
define('TABLE_HEADING_ACTION', 'Ac&ccedil;&atilde;o');
define('TABLE_HEADING_SHOPPING_CART', 'Carrinho de Compras');
define('TEXT_SHOPPING_CART_SUBTOTAL', 'Subtotal');
define('TEXT_NUMBER_OF_CUSTOMERS', 'Actualmente est&atilde;o %s clientes online');
