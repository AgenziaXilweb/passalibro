...
$query_lista .= " AND CONCAT(" . CATALOGO . ".isbn13,
" . CATALOGO . ".titolo," . CATALOGO . ".anno_edizione,
" . CATALOGO . ".editore) LIKE '%" . $_REQUEST['richiesta'] . "%'
GROUP BY titolo";  
    
}else{
    
$query_lista .= " AND " . ADOZSEDI . ".classe = '" . $_REQUEST['classe'] . "'
...
echo "<div class='roundedOne'><input type='radio' id='radio1' name='cercolibri' value='3' checked='checked'/><label for='radio1'>Tutti</label>
...
$pictures = file_exists(DIR_WS_ISBN . $listalibri['products_image'])? DIR_WS_ISBN . $listalibri['products_image']: DIR_WS_IMAGES . 'nopic.png';
        ...
        echo "<tr><td>".tep_image($pictures, $listalibri['titolo'],SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT)."</td><td align='center' width='20%'>" . str_replace('ISBN: [', '', $listalibri['isbn13']) .
