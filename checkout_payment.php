...
$banca=tep_sede_gateway($_SESSION['sede']);

$payment_modules = new payment($banca['circuito']);
...
#####################################################################################  
#### MARCO 01/10/2013 - INIZIO WAREHOUSE RICONTROLLO DISPONIBILITA' SEDE VENDITA ####
#####################################################################################
echo $_SESSION['sede'];
if(MODULE_WAREHOUSES_STATUS == 'True'){

tep_check_warehouse_customers_basket($customer_id,$_SESSION['sede']);

}

###################################################################################
#### MARCO 01/10/2013 - FINE WAREHOUSE RICONTROLLO DISPONIBILITA' SEDE VENDITA ####
###################################################################################
...
case 'success':
$message='<div class="success"><h1>Operazione eseguita con successo. Grazie a presto!!</h1></div>';
break;

case 'warning':
$message='<div class="warning"><h1>Ordine Annullato</h1></div>';
break;

case 'errore':
$message='<div class="error"><h1>Errore nel pagamento credenziali non valide o credito non disponibile</h1></div>';
break;
...
?>
  ...
  <div class="contentText">
    ...
    <?php echo TEXT_SELECTED_BILLING_DESTINATION; ?><br /><br /><?php echo tep_draw_other_button(IMAGE_BUTTON_CHANGE_ADDRESS, 'home', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL')); ?>
  </div>
