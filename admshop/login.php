    ...
    switch ($action) {
      case 'process':
        ...
        if ($actionRecorder->canPerform()) {
          $check_query = tep_db_query("select id, user_name, user_password, sede from " . TABLE_ADMINISTRATORS . " where user_name = '" . tep_db_input($username) . "'");
...
// migrate old hashed password to new phpass password
              ...
              $admin = array('id' => $check['id'],
                             ...
                             'sede' => $check['sede']);
              $settasede = $admin['sede'];
              $_SESSION['admsede'] = $settasede;
