...
// define the filenames used in the project
  ...
  define('FILENAME_SPECIALS_SEARCH', 'specials_search.php');
...
// ### MODIFICA PER GENERAZIONE ORDINE ###
...
// ### FINE GENERAZIONE ORDINE ###
// CREAZIONE CLIENTE
  define('FILENAME_CREATE_ACCOUNT', 'create_account.php');
  define('FILENAME_CREATE_ACCOUNT_PROCESS', 'create_account_process.php');
  define('FILENAME_CREATE_ACCOUNT_SUCCESS', 'create_account_success.php');
// FINE CREAZIONE CLIENTE
// GESTIONE MAGAZZINO
  define('FILENAME_WAREHOUSES', 'warehouses.php');
// FINE GESTIONE MAGAZZINO
// GESTIONE AMAZON
  define('FILENAME_AMAZON_SELLERS', 'amazon_sellers.php');
// FINE GESTIONE AMAZON
?>
