...
*/
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Da pagare a:&nbsp;' . MODULE_PAYMENT_MONEYORDER_PAYTO . '<br><br>' . 'Il tuo ordine non verrà spedito finchè non riceveremo il pagamento.');
