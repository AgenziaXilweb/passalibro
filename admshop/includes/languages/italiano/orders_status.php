...
define('TABLE_HEADING_DOWNLOADS_STATUS', 'Scarica Stato');
...
define('TEXT_SET_PUBLIC_STATUS', 'Visualizza l\'ordine in questo stato ai clienti');

define('TEXT_SET_DOWNLOADS_STATUS', 'Consenti lo scaricamento dei prodotti per questo stato di ordine');
