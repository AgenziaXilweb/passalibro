...
// DATI SCUOLA
define('TEXT_SCUOLA', 'Codice Scuola:');
define('TEXT_CLASSE', 'Classe:');
define('TEXT_SEZIONE', 'Sezione:');
...
define('TEXT_QUANTITY', 'Nuovo:');
define('TEXT_USED_QUANTITY', 'Usato:');
define('TEXT_RESERVED_QUANTITY', 'Prenotato:');
