...
define('BOX_IN_YOUR_CART','a Compras');
...
define('ERROR_TEP_MAIL', '<font face="Verdana, Arial" size="2" color="#760C0F"><b><small>TEP ERROR:</small> No he podido enviar el email con el servidor SMTP especificado. Configura tu servidor SMTP en la secci&oacute;n adecuada del fichero php.ini.</b></font>');
...
define('ARTICLE_1','Articulos 1');
define('ARTICLE_2','Articulos 2');
define('ARTICLE_3','Articulos 3');
define('ARTICLE_4','Articulos 4');
define('ARTICLE_5','Articulos 5');
define('BOX_WHOS_ONLINE','Que está en línea');
